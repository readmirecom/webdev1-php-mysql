...
$notes = $dbh->query("SELECT * FROM note")->fetchAll(PDO::FETCH_ASSOC);
$images = $dbh->query("SELECT * FROM image")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="col-xs-12 col-sm-6">
                <figure class="works-item">
                    ...
                    <figcaption class="works-item_text">
                        ...
                        <?php endif; ?>
                        <h3>
                            <a href="view_image.php?id=<?=$image['id']?>"><?=$image['title']?></a>
                        </h3>
                    </figcaption>
                </figure>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6">
                <div class="about-item">
                    <h4><a href="view_note.php?id=<?=$note['id']?>"><?=$note['title']?></a></h4>
                    <p><?=$note['content']?></p>
                </div>
            </div>
            <?php endforeach;?>
